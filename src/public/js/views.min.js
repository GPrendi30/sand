//EJS Compiled Views - This file was automatically generated on Sun Dec 19 2021 22:56:34 GMT+0100 (Central European Standard Time)
...
ejs.src_views_notif = function(locals, escapeFn, include = ejs.views_include(locals), rethrow
) {
rethrow = rethrow || function rethrow(err, str, flnm, lineno, esc){
  var lines = str.split('\n');
  var start = Math.max(lineno - 3, 0);
...
;
var __line = 1
  , __lines = "<% let notifications = [] %>\n\n<ul id=\"notifications\">\n    <% notifications.forEach( notif => { %>\n        <li class=\"notif\">\n            <h1 class=\"notif_title\"><%= notif.title %></h1>\n            <p class=\"notif_msg\"><%= notif.msg %></p>\n            <p class=\"notif_time\">Received <%= notif.timestamp %></p>\n            <button class=\"rmv_btn\">X</button>\n        </li>\n    <% }) %>\n</ul>"
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ...
    ; __line = 4
    ;  notifications.forEach( notif => { 
    ; __append("\n        <li class=\"notif\">\n            <h1 class=\"notif_title\">")
    ; __line = 6
    ; __append(escapeFn( notif.title ))
    ; __append("</h1>\n            <p class=\"notif_msg\">")
    ; __line = 7
    ; __append(escapeFn( notif.msg ))
    ; __append("</p>\n            <p class=\"notif_time\">Received ")
    ; __line = 8
    ; __append(escapeFn( notif.timestamp ))
    ; __append("</p>\n            <button class=\"rmv_btn\">X</button>\n        </li>\n    ")
    ; __line = 11
    ;  }) 
    ; __append("\n</ul>")
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 43
    ; __append(escapeFn( result._id ))
    ; __append("?req=surname\" enctype=\"multipart/form-data\">\n                        <label for=\"surname\">\n                            <h3>Surname</h3>\n                            <input class=\"input\" type=\"text\" name=\"surname\">\n                            <input class=\"button\" type=\"submit\" value=\"Change surname\">\n                        </label>\n                    </form>\n\n                    <form method=\"POST\" action=\"user/settings/")
    ; __line = 51
    ; __append(escapeFn( result._id ))
    ; __append("?req=email\" enctype=\"multipart/form-data\">\n                        <label for=\"email\">\n                            <h3>Email address</h3>\n                            <input class=\"input\" type=\"text\" name=\"email\" required>\n                            <input class=\"button\" type=\"submit\" value=\"Change email\">\n                        </label>\n                    </form>\n            \n                    <form method=\"POST\" action=\"user/settings/")
    ; __line = 59
    ; __append(escapeFn( result._id ))
    ; __append("?req=bio\" enctype=\"multipart/form-data\">\n                        <label for=\"bio\">\n                            <h3>Biography</h3>\n                            <input class=\"input\" type=\"text\" name=\"bio\">\n                            <input class=\"button\" type=\"submit\" value=\"Change bio\">\n                        </label>\n                    </form>\n                </div>\n\n                \n            </section>\n\n        <!-- <form method=\"POST\" action=\"/user/settings/")
    ; __line = 71
    ; __append(escapeFn( result._id ))
    ...
    ; __line = 79
    ; __append(escapeFn( result._id ))
    ; __append("?req=password\" enctype=\"multipart/form-data\">\n                    <label for=\"old_password\">\n                        <h3>Old Password</h3>\n                        <input class=\"input\" type=\"text\" name=\"old_password\" required>\n                    </label>\n        \n                    <label for=\"new_password\">\n                        <h3>New Password</h3>\n                        <input class=\"input\" type=\"password\" name=\"new_password\" required>\n                    </label>\n        \n                    <label for=\"confirm_new_password\">\n                        <h3>Confirm New Password</h3>\n                        <input class=\"input\" type=\"password\" name=\"confirm_new_password\" required>\n                    </label>\n                    \n                    <input class=\"button\" type=\"submit\" value=\"Change password\">\n                </form>\n            </section>\n\n        <!-- <form method=\"POST\" action=\"/user/settings/")
    ; __line = 99
    ; __append(escapeFn( result._id ))
