//EJS Compiled Views - This file was automatically generated on Sun Dec 12 2021 23:32:02 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("?req=password&_method=PUT\" enctype=\"multipart/form-data\">\n\n            <label for=\"old_password\">Old password:</label>\n            <input type=\"text\" name=\"old_password\" required>\n\n            <label for=\"new_password\">New password:</label>\n            <input type=\"password\" name=\"new_password\" required>\n\n            <label for=\"confirm_new_password\">Confirm new password:</label>\n            <input type=\"password\" name=\"confirm_new_password\" required>\n            \n            <input type=\"submit\" value=\"Change password\">\n        </form>\n\n        <form method=\"POST\" action=\"/user/settings/")
    ; __line = 18
    ; __append(escapeFn( result._id ))
...
;
var __line = 1
  , __lines = "<section class=\"room\">\n    <!-- central part -->\n    <section class=\"chat\">\n        <p id=\"messages\"><%= room.messages%></p>\n    </section>\n\n    <!-- below the chat messages -->\n    <section class=\"input\">\n        <label for=\"msg\"></label>\n\t\t<input id=\"msg\" type=\"text\" name=\"msg\" value=\"\" placeholder=\"Type here your message\"/>\n\t\t<button id=\"send\">Send</button>\n        <button id=\"leave_room\">Leave room</button>\n    </section>\n\n    <!-- member list aside -->\n    <section class=\"members\">\n        <section><%= room.owner%></section>\n        <section><%= room.admin%></section>\n        <section><%= room.members %></section>\n    </section>\n</section>  "
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ; __append("<section class=\"room\">\n    <!-- central part -->\n    <section class=\"chat\">\n        <p id=\"messages\">")
    ; __line = 4
    ; __append(escapeFn( room.messages))
    ; __append("</p>\n    </section>\n\n    <!-- below the chat messages -->\n    <section class=\"input\">\n        <label for=\"msg\"></label>\n		<input id=\"msg\" type=\"text\" name=\"msg\" value=\"\" placeholder=\"Type here your message\"/>\n		<button id=\"send\">Send</button>\n        <button id=\"leave_room\">Leave room</button>\n    </section>\n\n    <!-- member list aside -->\n    <section class=\"members\">\n        <section>")
    ; __line = 17
    ; __append(escapeFn( room.owner))
    ; __append("</section>\n        <section>")
    ; __line = 18
    ; __append(escapeFn( room.admin))
    ; __append("</section>\n        <section>")
    ; __line = 19
    ; __append(escapeFn( room.members ))
    ; __append("</section>\n    </section>\n</section>  ")
    ; __line = 21
  }
  return __output.join("");
