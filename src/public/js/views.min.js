//EJS Compiled Views - This file was automatically generated on Mon Dec 20 2021 01:19:44 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 18
    ;  rooms.forEach( item => { 
    ; __append("\n                <li class=\"discover_item grow_hover shadow\"><a href=\"/rooms/")
    ; __line = 19
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("\">\n                        <h1 id=\"username\"> ")
    ; __line = 63
    ; __append(escapeFn( author.username ))
    ; __append(" </h1>\n                    </li>\n                        ")
    ; __line = 65
    ;  admins.forEach( admin=> { 
    ; __append("\n                            ")
