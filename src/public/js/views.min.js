//EJS Compiled Views - This file was automatically generated on Fri Dec 17 2021 11:06:10 GMT+0100 (Central European Standard Time)
...
;
var __line = 1
  , __lines = "\n    <section> <%= user.username %> </section>\n    <section id=\"name\"><%= user.name %> </section>\n    <section id=\"surname\"><%= user.surname%> </section>\n    <img id=\"ppic\" src=<%= user.ppic %>>\n    <section> <%= user.email %></section>\n    <button type = \"button\" id=\"settings\" name=\"settings\"> Settings </button>\n    <section id=\"bio\"><%= user.bio %> </section>\n    <section id=\"friendlist\"><%= user.friendlist%> </section>\n    <section id=\"friendrequests\"><%= user.friendrequests %> </section>\n    <section id=\"blocked\"><%= user.blocked%> </section>\n    <section id=\"tracking\"><%= user.tracking %> </section>\n    <section id=\"recentlyviewed\"><%= user.recentlyviewed %> </section>\n    <section id=\"collection\"><%= user.collection%> </section>"
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ...
    ; __append(" </section>\n    <section id=\"friendlist\">")
    ; __line = 9
    ; __append(escapeFn( user.friendlist))
    ; __append(" </section>\n    <section id=\"friendrequests\">")
    ; __line = 10
    ; __append(escapeFn( user.friendrequests ))
    ; __append(" </section>\n    <section id=\"blocked\">")
    ; __line = 11
    ; __append(escapeFn( user.blocked))
    ; __append(" </section>\n    <section id=\"tracking\">")
    ; __line = 12
    ; __append(escapeFn( user.tracking ))
    ; __append(" </section>\n    <section id=\"recentlyviewed\">")
    ; __line = 13
    ; __append(escapeFn( user.recentlyviewed ))
    ; __append(" </section>\n    <section id=\"collection\">")
    ; __line = 14
    ; __append(escapeFn( user.collection))
    ; __append(" </section>")
  }
  return __output.join("");
} catch (e) {
