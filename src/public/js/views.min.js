//EJS Compiled Views - This file was automatically generated on Mon Dec 20 2021 01:44:28 GMT+0100 (Central European Standard Time)
...
;
var __line = 1
  , __lines = "<aside>\n\n    <img class=\"aside_button\" src=\"/images/news.svg\">\n\n    <img class=\"aside_button\" src=\"/images/chat.svg\">\n\n</aside>\n\n\n"
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
...
;
var __line = 1
  , __lines = "<section class=\"single_collection\">\n\n    <section>\n        <img src=\"<%= collection.img %>\" alt=\"the image of the collection\">\n        <button id=\"track\">\n            Track\n        </button>\n    </section>\n\n\n    <section id=\"collection_info\">\n        <h1 id=\"collection_title\"><%= collection.title %></h1> \n        <p id=\"collection_desc\"><%= collection.description %></p>\n        <a href=\"<%= collection.OpenSea_link %>\">  Link to OpenSea: </a>\n    </section>\n\n    <section id=\"collection_stats\">\n        <div>\n            <h5>Total Volume: <%= collection.total_volume %> </h5>\n        </div>\n        <div>\n            <h5>Floor Price: <%= collection.floor_price %> </h5>\n        </div>\n        <div>\n            <h5>Average Price: <%= collection.average_price %> </h5>\n        </div>\n        <div>\n            <h5>Created At: <%= collection.created_date %> </h5>\n        </div>\n\n        <div>\n            <h5><%= collection.num_owners %> people own at least one.</h5>\n        </div>\n\n        <div>\n            <h5>Total Supply: <%= collection.num_assets %></h5>\n        </div>\n\n        <div>\n            <h5>Total Sales: <%= collection.total_sales %></h5>\n        </div>\n\n    </section>\n\n    <section id=\"collection_graphs\">\n        \n    </section>\n\n   \n</section>  "
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ...
    ; __append(" people own at least one.</h5>\n        </div>\n\n        <div>\n            <h5>Total Supply: ")
    ; __line = 36
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("</p>\n                        <p id = \"time_stamp\"> ")
    ; __line = 29
    ; __append(escapeFn( new Date(msg.timestamp).toLocaleTimeString() ))
    ; __append("</p>\n                            ")
    ; __line = 30
    ;  if (msg.user !=prev) { 
    ; __append("\n                                ")
    ...
    ; __append("\n                            ")
    ; __line = 92
    ; __append( include('includes/room_member', {user:user, role:'user'}) )
    ; __append("\n                        ")
    ; __line = 93
    ;  }); 
    ; __append("\n                    </ul>\n                    \n                </section>\n            </section>\n            <section id=\"normal_members\">\n\n                <h2>Members</h2>\n                <ul class=\"member_list\">\n\n                    <!-- TODO: Implement this version instead -->\n                    ")
