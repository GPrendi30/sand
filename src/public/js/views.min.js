//EJS Compiled Views - This file was automatically generated on Mon Dec 20 2021 09:46:39 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("?req=name\" enctype=\"multipart/form-data\">\n                        <label for=\"name\">\n                            <h3>Name</h3>\n                            <input class=\"input\" type=\"text\" name=\"name\" required>\n                            <input class=\"button\" type=\"submit\" value=\"Change name\">\n                        </label>\n                    </form>\n\n                    <form method=\"POST\" action=\"user/settings/")
    ; __line = 36
    ; __append(escapeFn( result._id ))
    ; __append("?req=surname\"\n                        enctype=\"multipart/form-data\">\n                        <label for=\"surname\">\n                            <h3>Surname</h3>\n                            <input class=\"input\" type=\"text\" name=\"surname\">\n                            <input class=\"button\" type=\"submit\" value=\"Change surname\">\n                        </label>\n                    </form>\n\n                    <form method=\"POST\" action=\"user/settings/")
    ; __line = 45
    ; __append(escapeFn( result._id ))
    ; __append("?req=email\"\n                        enctype=\"multipart/form-data\">\n                        <label for=\"email\">\n                            <h3>Email address</h3>\n                            <input class=\"input\" type=\"text\" name=\"email\" required>\n                            <input class=\"button\" type=\"submit\" value=\"Change email\">\n                        </label>\n                    </form>\n\n                    <form method=\"POST\" action=\"/user/settings?req=bio&_method=PUT\" enctype=\"multipart/form-data\">\n                    <form method=\"POST\" action=\"/user/settings/")
    ; __line = 55
    ; __append(escapeFn( result._id ))
    ; __append("?req=bio&_method=PUT\"\n                        enctype=\"multipart/form-data\">\n                        <label for=\"bio\">\n                            <h3>Biography</h3>\n                            <input class=\"input\" type=\"text\" name=\"bio\" value=\"")
    ; __line = 59
...
;
var __line = 1
  , __lines = "<html>\n\n<head>\n    <link rel='stylesheet' href='/stylesheets/general.css' />\n    <link rel='stylesheet' href='/stylesheets/style.css' />\n    <link rel='stylesheet' href='/stylesheets/header.css' />\n    <link rel='stylesheet' href='/stylesheets/navbar.css' />\n    <link rel='stylesheet' href='/stylesheets/navbar_min.css' />\n    <link rel='stylesheet' href='/stylesheets/discover.css' />\n    <link rel='stylesheet' href='/stylesheets/follow.css' />\n    <link rel='stylesheet' href='/stylesheets/friendlist.css' />\n    <link rel='stylesheet' href='/stylesheets/footer.css' />\n    <link rel='stylesheet' href='/stylesheets/aside.css' />\n    <link rel='stylesheet' href='/stylesheets/login_signup.css' />\n    <link rel='stylesheet' href='/stylesheets/rooms.css' />\n    <link rel='stylesheet' href='/stylesheets/profile.css' />\n    <link rel='stylesheet' href='stylesheets/settings.css' />\n    <link rel='stylesheet' href='stylesheets/notif_list.css' />\n    <link rel='stylesheet' href='stylesheets/single_room.css' />\n</head>\n<section class=\"single_collection\">\n\n    <section>\n        <img src=\"<%= collection.img %>\" alt=\"the image of the collection\">\n        <button id=\"track\">\n            Track\n        </button>\n    </section>\n\n\n    <section id=\"collection_info\">\n        <h1 id=\"collection_title\">\n            <%= collection.title %>\n        </h1>\n        <p id=\"collection_desc\">\n            <%= collection.description %>\n        </p>\n        <a href=\"<%= collection.OpenSea_link %>\"> Link to OpenSea: </a>\n    </section>\n\n    <section id=\"collection_stats\">\n\n\n\n        <ul>\n            <h5>Total Volume: <%= collection.total_volume %>\n            </h5>\n        </ul>\n        <div>\n            <h5>Floor Price: <%= collection.floor_price %>\n            </h5>\n        </div>\n        <div>\n            <h5>Average Price: <%= collection.average_price %>\n            </h5>\n        </div>\n        <div>\n            <h5>Created At: <%= collection.created_date %>\n            </h5>\n        </div>\n\n        <div>\n            <h5>\n                <%= collection.num_owners %> people own at least one.\n            </h5>\n        </div>\n\n        <div>\n            <h5>Total Supply: <%= collection.num_assets %>\n            </h5>\n        </div>\n\n        <div>\n            <h5>Total Sales: <%= collection.total_sales %>\n            </h5>\n        </div>\n        </ul>\n    </section>\n\n    <section id=\"collection_graphs\">\n\n    </section>\n\n\n</section>\n</div>\n</div>\n\n</html>"
  , __filename = undefined;
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ...
    ; __append("\n            </h5>\n        </div>\n\n        <div>\n            <h5>\n                ")
    ; __line = 64
    ; __append(escapeFn( collection.num_owners ))
    ; __append(" people own at least one.\n            </h5>\n        </div>\n\n        <div>\n            <h5>Total Supply: ")
    ; __line = 69
    ; __append(escapeFn( collection.num_assets ))
    ; __append("\n            </h5>\n        </div>\n\n        <div>\n            <h5>Total Sales: ")
    ; __line = 74
    ; __append(escapeFn( collection.total_sales ))
    ; __append("\n            </h5>\n        </div>\n        </ul>\n    </section>\n\n    <section id=\"collection_graphs\">\n\n    </section>\n\n\n</section>\n</div>\n</div>\n\n</html>")
    ; __line = 89
  }
  return __output.join("");
