//EJS Compiled Views - This file was automatically generated on Sun Dec 19 2021 23:14:59 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 4
    ; __append(escapeFn( collection.link ))
    ; __append("\" alt=\"the image of the collection\">\n        <button id=\"track\">\n            Track\n        </button>\n    </section>\n\n\n    <section id=\"collection_info\">\n        <h1 id=\"collection_title\">")
    ; __line = 12
    ; __append(escapeFn( collection.name ))
    ; __append("</h1>\n        <h3 id=\"collection_owner\">")
    ; __line = 13
    ; __append(escapeFn( collection.owner ))
    ; __append("</h3>\n        <p id=\"collection_id\">")
    ; __line = 14
    ; __append(escapeFn( collection.token_id ))
    ...
    ; __append(" </h5>\n        </div>\n        <div>\n            <h5>Asset Count : ")
    ; __line = 27
    ; __append(escapeFn( collection.asset_count ))
    ; __append(" </h5>\n        </div>\n        <div>\n            <h5>Average Price: ")
    ; __line = 30
