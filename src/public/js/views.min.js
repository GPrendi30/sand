//EJS Compiled Views - This file was automatically generated on Sun Dec 19 2021 13:38:46 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 35
    ; __append(escapeFn( result._id ))
    ; __append("?req=settings\" enctype=\"multipart/form-data\">\n                        <label for=\"email\">\n                            <h3>Email address</h3>\n                            <input class=\"input\" type=\"text\" name=\"email\" required>\n                            <input class=\"button\" type=\"submit\" value=\"Change email\">\n                        </label>\n                    </form>\n            \n                    <form method=\"POST\" action=\"user/settings/")
    ; __line = 43
    ; __append(escapeFn( result._id ))
